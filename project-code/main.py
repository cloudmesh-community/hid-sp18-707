...
tweets = spark.read.json("file:/root/spark-2.3.0-bin-hadoop2.7/bin/twitter.json")
...
print 'The most popular retweet is: '+ str(most_popular_retweet)
...
print 'The mean polarity for sentiment of this dataset is '+str(np.mean(polarity_list))+'.'
